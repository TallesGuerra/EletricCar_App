...
class CarRepository(private val context: Context) {
    fun save(carro: Carro): Boolean {
        ...
        try {
            ...
            val values = ContentValues().apply {
                ...
                // ATENÇÃO: Você estava trocando bateria e potência
            ...
            if (inserted != null && inserted > 0) { // Checagem mais robusta
                isSaved = true
            }
    ...
    fun findCarById(id: Int): Carro {
        ...
        var itemId: Long = ID_WHEN_NO_CAR.toLong() // Use a constante para o valor padrão
        var preco = ""
        var bateria = ""
        var potencia = ""
        var recarga = ""
        ...
        with(cursor) {
            if (moveToNext()) { // Use if em vez de while, pois você só espera um resultado
